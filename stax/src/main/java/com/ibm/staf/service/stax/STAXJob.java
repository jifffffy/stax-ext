                                ...
                                STAXSTAFQueueListener
{
        ...
        for (STAXFunctionImport functionImport : importList)
        {
            ...
            for (String fileName : theFileList)
            {
                ...
                if (importedFunctionList.isEmpty())
                    ...
                    functionSet = new LinkedHashSet<String>(importedFunctionList);
    ...
    public void threadComplete(STAXThread thread, int endCode)
    {
        ...
        // printed.  This is because if a STAX job uses sys.stdout.write
        // or sys.stderr.write in a script element, it is possible that
        ...
        if (jobComplete == true)
        {
            ...
            fCompletionNotifiees = new LinkedList<STAXJobCompleteListener>();
            fCompiledPyCodeCache = new HashMap<String, PyCode>();
    ...
    private List<String> fScripts = new ArrayList<String>();
     ...
     * using a common STAXTimedEventQueue for all jobs.
     */
    private STAXTimedEventQueue fTimedEventQueue = null;

    // fExecuteAndHold:  null indicates no hold
    //                   blank indicates hold with no timeout
    //                   otherwise indicates hold with a timeout
    private String fExecuteAndHold = null;
