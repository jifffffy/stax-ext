...
public class STAX implements STAFServiceInterfaceLevel30, STAXJobCompleteListener
{
    ...
    static final String sTimedEventMapClassName = new String(
        "STAF/Service/STAX/TimedEvent");
        ...
        try
        {
            ...
            if (info.parms != null)
            {
                ...
                fParmsParser.addOption("EVENTSERVICENAME", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                fParmsParser.addOption("EVENTGENERATION", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                ...
                fParmsParser.addOption("PROCESSTIMEOUT", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                fParmsParser.addOption("RESETJOBID", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                ...
                fParmsParser.addOption("PYTHONLOGLEVEL", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                fParmsParser.addOption("INVALIDLOGLEVELACTION", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                ...
                fParmsParser.addOption("MAXSTAXTHREADS", 1,
                                       STAFCommandParser.VALUEREQUIRED);
                fParmsParser.addOption("TIMEDEVENTQUEUE", 1,
                                       STAFCommandParser.VALUEREQUIRED);
            ...
            fQueryJobMapClass.addKey("invalidLogLevelAction",
                                     "Invalid Log Level Action");
            ...
            synchronized (fExtensionsJarList)
            {
                StringBuffer result = new StringBuffer(
                    "Registered Extensions for " + fServiceName +
                    " Version " + fVersion + ": ");
...
// End DTD chunk..............................................................
    ...
    public String getServicePath() { return fServicePath; }
    ...
    public boolean getResetJobID() { return fResetJobID; }
                                    ...
                                    STAXJobCompleteListener listener)
    {
        ...
        try
        {
            ...
            for (STAXFunctionAction functionAction :
                 job.getSTAXDocument().getFunctionMap().values())
            {
        ...
        if (parseResult.optionTimes("WAIT") > 0)
        {
            ...
            if (parseResult.optionTimes("RETURNRESULT") > 0)
            {
                ...
                Map<String, Object> jobResultMap =
                    new TreeMap<String, Object>();
                ...
                if (!details)
                {
                    ...
                    jobResultMap.put("staf-map-class-name",
                                     fJobResultMapClass.name());
                }
                else
                {
                    ...
                    jobResultMap.put("staf-map-class-name",
                                     fJobDetailedResultMapClass.name());
                }
    ...
    private STAFResult loadExtensions()
    {
        ...
        for (STAXExtension ext : fExtensionsJarList)
        {
            ...
            ClassLoader loader = new STAXExtensionClassLoader(
            ...
            for (String elementName : manifestEntryMap.keySet())
            {
                ...
                fActionFactoryMap.put(elementName,
                                      (STAXActionFactory)extFactoryObj);
    ...
    {        
        ...
        System.out.println(
        	currTimestamp.getTimestampString() + " " + level + " " +
            jobInfo.toString() + message);
    }
    ...
    public void visitJobManagementHandlers(STAXVisitor visitor)
    {
        synchronized (fJobManagementHandlerSet)
        {
            Iterator<STAXJobManagementHandler> iter =
                fJobManagementHandlerSet.iterator();
    ...
    private static class STAXJobManagementHandlerComparator
        implements Comparator<STAXJobManagementHandler>
    {
